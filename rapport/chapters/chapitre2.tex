...
\begin{tikzpicture}[scale=0.85, every node/.style={transform shape}]
    ...
    \draw[<->, >=latex, thick] (nginx.east) -| (django.north) node[pos=0.3, above, fill=emsiblue!5, inner sep=1.5pt] {{\scriptsize Static}};
    ...
    \draw[<->, >=latex, thick] (gunicorn.east) -| (django.south) node[pos=0.3, below, fill=emsiblue!5, inner sep=1.5pt] {{\scriptsize WSGI}};
