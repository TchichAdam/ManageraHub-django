...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{diagrams/email_welcome_template.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{diagrams/email_status_template.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{diagrams/oauth_login_buttons.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{diagrams/oauth_login_error.png}
